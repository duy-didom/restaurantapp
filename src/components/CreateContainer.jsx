  ...
  const saveDetails = () => {
    ...
    try {
      if ((!title || !calories || !imageAsset || !price || !category)) {
        ...
        setIsLoading(false)
        setFields(true);
        setMsg("Data uploaded succressfully");
        clearData();
        setAlertStatus("success");
        setTimeout(() => {
          setFields(false);
  ...
  return (
    <div className="w-full min-h-screen flex items-center justify-center">
      <div className='w-[90%] md:w-[50%] border border-gray-300 rounded-lg p-4 flex flex-col items-center justify-center gap-4'>
        ...
        items-center flex-col border-2 border-dotted border-gray-300 w-full h-225 md:h-420
        ...
        <div className='flext items-center w-full'>
